"""
Chargeur robuste de modèles Darts optimisé.

Ce module gère le chargement des modèles PyTorch/Darts en contournant les interférences
et les incompatibilités de versions (Numpy BitGenerator, Streamlit stubs).
"""
...
# =============================================================================
# Streamlit stubs (for safe unpickling if model was saved in Streamlit env)
# =============================================================================
...
def load_model_safe(model_path: Path, model_type: str) -> Any:
    ...
    # 3. Application du patch temporaire
