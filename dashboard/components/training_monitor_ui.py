"""
UI de monitoring d'entraînement pour Streamlit.

Affiche la progression de l'entraînement en utilisant les métriques
lues par TrainingMonitor.
"""
...
def display_progress(
    ...
    *,
    ...
    Args:
        monitor: Instance de TrainingMonitor
    ...
    if status_text:
        if status == 'training':
            ...
            if rerun_on_complete:
                ...
                _rerun_key = f"_monitor_rerun_{monitor.metrics_file}"
